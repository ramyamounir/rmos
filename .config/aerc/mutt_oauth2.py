...
home_dir = os.getenv("XDG_CONFIG_HOME", os.getenv("HOME", "~"))
env_path = os.path.join(home_dir, "aerc", ".env")
...
ENCRYPTION_PIPE = ["gpg", "--encrypt", "--recipient", os.environ["GPG_RECIPIENT_EMAIL"]]
